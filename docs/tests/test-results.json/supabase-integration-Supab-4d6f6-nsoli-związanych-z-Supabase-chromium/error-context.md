...
- generic [ref=e1]:
  ...
  - banner [ref=e4]:
    ...
    - tablist "Nawigacja główna" [ref=e51]:
      - tab "🎯 Twoja przygoda" [selected] [ref=e52] [cursor=pointer]
  ...
  - main [ref=e56]:
    - heading "WakacjeCypr Quest – interaktywny przewodnik po Cyprze" [level=1] [ref=e57]
    - tabpanel "🎯 Twoja przygoda" [ref=e58]:
      - generic [ref=e60]:
        - heading "Aktualna lokalizacja" [level=2] [ref=e61]
        - generic [ref=e62]:
          - link "Pomiń interaktywną mapę" [ref=e63] [cursor=pointer]:
            - /url: "#mapSkipTarget"
          - link "Zobacz na Mapach Google" [ref=e64] [cursor=pointer]:
            - /url: https://maps.google.com/?q=34.75567,32.40417
        - generic "Interaktywna mapa atrakcji" [ref=e65]
        - paragraph [ref=e66]: Pominięto mapę. Przejdź do kolejnych informacji o lokalizacji.
        - generic [ref=e67]:
          - heading "Aktualna lokalizacja" [level=2] [ref=e68]
          - paragraph [ref=e69]: Kato Paphos Archaeological Park (Nea Paphos)
          - paragraph [ref=e70]: Expansive UNESCO site with famous mosaics and the ruins of the ancient city of Nea Paphos.
          - paragraph [ref=e71]:
            - link "Zobacz na Mapach Google" [ref=e72] [cursor=pointer]:
              - /url: https://maps.google.com/?q=34.75567,32.40417
          - generic [ref=e73]:
            - button "Brak poprzedniego miejsca" [disabled] [ref=e74]: ← Poprzednie miejsce
            - 'button "Przejdź do następnego miejsca: Tombs of the Kings in Paphos" [ref=e75] [cursor=pointer]': Następne miejsce →
          - button "Zamelduj się i zdobądź XP" [ref=e76] [cursor=pointer]
          - paragraph [ref=e77]: "Wskazówka: pozwól aplikacji użyć Twojej lokalizacji, aby potwierdzić, że jesteś na miejscu."
          - paragraph [ref=e78]: Gdy dotrzesz na miejsce, kliknij „Zamelduj się”, aby zdobyć odznakę.
      - complementary [ref=e79]:
        - region "Szybkie przejścia" [ref=e80]:
          - button "🎒 Planowanie pakowania Zaplanuj walizkę w dedykowanej karcie z listami rzeczy na różne sezony podróży. Przejdź do planera" [ref=e81] [cursor=pointer]:
            - heading "🎒 Planowanie pakowania" [level=2] [ref=e82]
            - paragraph [ref=e83]: Zaplanuj walizkę w dedykowanej karcie z listami rzeczy na różne sezony podróży.
            - generic [ref=e84]: Przejdź do planera
          - button "✅ Lista zadań Przejrzyj wyzwania przed wyjazdem i zapisuj swój postęp w osobnej zakładce. Otwórz zadania" [ref=e85] [cursor=pointer]:
            - heading "✅ Lista zadań" [level=2] [ref=e86]
            - paragraph [ref=e87]: Przejrzyj wyzwania przed wyjazdem i zapisuj swój postęp w osobnej zakładce.
            - generic [ref=e88]: Otwórz zadania
          - button "Kup kupon — przejdź do bezpiecznej płatności Stripe" [ref=e89] [cursor=pointer]:
            - heading "💸 Kupon" [level=2] [ref=e90]
            - paragraph [ref=e91]: Najprostszy sposób, by skorzystać z naszej oferty — bez formalności.
            - generic [ref=e92]: Kup kupon
          - button "🚗 Wynajem auta na Cyprze Poznaj całą flotę, porównaj ceny i zarezerwuj samochód na dedykowanej stronie. Przejdź do wynajmu" [ref=e93] [cursor=pointer]:
            - heading "🚗 Wynajem auta na Cyprze" [level=2] [ref=e94]
            - paragraph [ref=e95]: Poznaj całą flotę, porównaj ceny i zarezerwuj samochód na dedykowanej stronie.
            - generic [ref=e96]: Przejdź do wynajmu
      - region "Atrakcje i postępy" [ref=e97]:
        - generic [ref=e98]:
          - generic [ref=e99]:
            - generic [ref=e100]:
              - heading "Atrakcje do odkrycia" [level=2] [ref=e101]
              - paragraph [ref=e102]: Przeglądaj miejsca z gry i planuj kolejne check-iny z mapy.
            - generic [ref=e103]:
              - button "Pokaż wszystkie 58 atrakcji" [ref=e104] [cursor=pointer]
              - link "📚 Katalog atrakcji" [disabled] [ref=e105] [cursor=pointer]:
                - /url: /attractions.html?lang=pl
          - list [ref=e106]:
            - listitem [ref=e107] [cursor=pointer]:
              - strong [ref=e108]: Kato Paphos Archaeological Park (Nea Paphos)
              - generic [ref=e109]: Nea Paphos Curator • 210 XP
            - listitem [ref=e110] [cursor=pointer]:
              - strong [ref=e111]: Tombs of the Kings in Paphos
              - generic [ref=e112]: Necropolis Guardian • 190 XP
            - listitem [ref=e113] [cursor=pointer]:
              - strong [ref=e114]: Coral Bay Beach
              - generic [ref=e115]: Beach Explorer • 110 XP
            - listitem [ref=e116] [cursor=pointer]:
              - strong [ref=e117]: Skała Afrodyty (Petra tou Romiou)
              - generic [ref=e118]: Strażnik Mitów • 120 XP
            - listitem [ref=e119] [cursor=pointer]:
              - strong [ref=e120]: Błękitna Laguna (Akamas)
              - generic [ref=e121]: Łowca Turkusu • 220 XP
            - listitem [ref=e122] [cursor=pointer]:
              - strong [ref=e123]: Stanowisko archeologiczne Kurion
              - generic [ref=e124]: Obrońca Kurionu • 200 XP
            - listitem [ref=e125] [cursor=pointer]:
              - link "Przejdź do sekcji wynajmu auta na Cyprze" [ref=e126]:
                - /url: car-rental.html
                - strong [ref=e127]:
                  - generic [ref=e128]: 🚗
                  - text: Wynajem auta na Cyprze
                - generic [ref=e129]: Odbierz samochód z lotniska lub spod hotelu
    - region "Planowanie podróży i inspiracje" [ref=e130]:
      - heading "Odkryj z nami Cypr" [level=2] [ref=e131]
      - paragraph [ref=e132]: WakacjeCypr.com to lokalni eksperci gotowi zorganizować dla Ciebie niezapomniane wakacje, prywatne wycieczki, degustacje wina i rejsy.
      - list [ref=e133]:
        - listitem [ref=e134]: Indywidualne plany podróży dopasowane do Twoich check-inów.
        - listitem [ref=e135]: Wycieczki z przewodnikiem w miejscach, które już odblokowałeś.
        - listitem [ref=e136]: Kontakt z nami prosto z aplikacji – kliknij przycisk poniżej.
      - link "Poznaj nasze usługi" [ref=e137] [cursor=pointer]:
        - /url: https://wakacjecypr.com
  - contentinfo [ref=e138]:
    - paragraph [ref=e139]: © 2025 WakacjeCypr.com • Graj, zwiedzaj i planuj wakacje jednocześnie.
    - button "🔁 Pokaż instrukcję" [ref=e140] [cursor=pointer]
  ...
  - button "Language selector" [ref=e141] [cursor=pointer]:
    - generic [ref=e142]: 🇵🇱
    - generic [ref=e143]: PL
  - generic [ref=e144]:
    - generic: ⬆️
    - dialog "Poznaj szybkie akcje" [ref=e146]:
      - generic [ref=e147]:
        - heading "Poznaj szybkie akcje" [level=2] [ref=e148]
        - paragraph [ref=e149]: Przyciski w nagłówku pomagają natychmiast przeskoczyć do celu, otworzyć wynajem aut, katalog atrakcji lub panel SOS.
      - generic [ref=e150]:
        - button "Wstecz" [disabled] [ref=e151]
        - button "Pomiń" [ref=e152] [cursor=pointer]
        - button "Dalej" [active] [ref=e153] [cursor=pointer]
```