...
describe('Hotels V2 ADMIN-C pricing UI/static gate', () => {
  test('wires the dedicated pricing control after Rooms and before Calendar', () => {
    ...
    expect(repository).toContain("pricingControl: 'hotel_v2_admin_get_pricing_control_114490'");
    expect(repository).toContain("applyPricingControl: 'hotel_v2_admin_apply_pricing_control_plan_114490'");
    expect(repository).toContain("previewPricingQuote: 'hotel_v2_admin_preview_pricing_quote_114490'");
