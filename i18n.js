(function () {
  ...
  const translations = {
    en: {
      ...
      'packing.season.spring.summary':
        'Mild days (17–28°C) and crisp evenings. Pack layers and light protection for passing showers.',
      'packing.season.summer.label': 'Summer',
      'packing.season.summer.summary':
        'Heat above 30°C, the sea warms to 26–27°C and rain is rare. Focus on lightweight clothes and strong sun protection.',
      'packing.season.autumn.label': 'Autumn',
      'packing.season.autumn.summary':
        'September stays hot, while October and November bring pleasant 21–30°C. The sea remains warm and rain usually appears late in the season.',
      'packing.season.winter.label': 'Winter',
      'packing.season.winter.summary':
        'Coastal days reach 15–18°C with cool nights and possible snow in the Troodos mountains. It’s the rainy season—pack layers and waterproof outerwear.',
      ...
      'packing.guide.universal.electronics.hint':
        'Save important contacts and keep enough power for a full day of exploring.',
      'packing.guide.universal.adapter.label': 'Type G plug adapter',
      'packing.guide.universal.adapter.hint':
        'Cyprus uses the British 240 V standard with three rectangular pins.',
      'packing.guide.universal.firstAid.label': 'Basic first aid kit and toiletries',
      'packing.guide.universal.firstAid.hint':
        'Prescription medicine, painkillers, anti-diarrhoea and motion sickness remedies, plus mosquito spray.',
      'packing.guide.universal.sunProtection.label': 'Sun protection',
      'packing.guide.universal.sunProtection.hint':
        'SPF 30–50 sunscreen, UV sunglasses and a hat are needed throughout the year.',
      ...
      'packing.guide.universal.comfort.hint':
        'Earplugs, sleep mask and travel pillow make flights or night journeys more comfortable.',
      ...
      'packing.guide.seasons.spring.camera.hint': 'Capture Cyprus in bloom—it is at its most photogenic now.',
      ...
      'packing.guide.seasons.summer.sunscreen.label': 'SPF 30–50 sunscreen',
      ...
      'tasks.status.reverted': 'Task "{{title}}" unmarked (−{{xp}} XP).{{note}}',
      'tasks.status.levelReverted': ' You returned to level {{level}}.',
      'tasks.items.sunrise-challenge.title': 'Sunrise beach walk',
      'tasks.items.sunrise-challenge.description':
        'Wake up before sunrise and take a short stroll along one of Cyprus\' beaches.',
      'tasks.items.taste-halloumi.title': 'Try local halloumi',
      'tasks.items.taste-halloumi.description':
        'Visit a tavern and sample freshly grilled halloumi—log the place in your travel journal.',
      'tasks.items.nicosia-day-trip.title': 'Day trip to Nicosia',
      'tasks.items.nicosia-day-trip.description':
        'Plan a half-day visit to Cyprus\' capital and step into at least one museum or gallery.',
      'tasks.items.troodos-wine-route.title': 'Wine tasting in the mountains',
      'tasks.items.troodos-wine-route.description':
        'Use our Troodos Wine Route offer and book a tasting with driver through WakacjeCypr.com.',
      'tasks.items.sea-adventure.title': 'Sea adventure in Cape Greco',
      'tasks.items.sea-adventure.description':
        'Choose one of our sea experiences (kayak, snorkel, cruise) and book it in Cape Greco.',
      'tasks.items.nicosia-green-line-walk.title': 'Green Line walk',
      'tasks.items.nicosia-green-line-walk.description':
        'Discover Nicosia\'s division history on a walk with a local guide.',
      'tasks.items.loukoumi-workshop.title': 'Loukoumi workshop in Geroskipou',
      'tasks.items.loukoumi-workshop.description':
        'Join a traditional sweets workshop and take home a souvenir set.',
      'tasks.items.akamas-jeep-safari.title': 'Akamas 4x4 safari',
      'tasks.items.akamas-jeep-safari.description':
        'Use our 4x4 safari and visit Avakas Gorge and Lara Beach with a WakacjeCypr.com guide.',
      'tasks.items.zenobia-dive-challenge.title': 'Zenobia wreck dive challenge',
      'tasks.items.zenobia-dive-challenge.description':
        'Join our organised dive on the Zenobia wreck with a licensed instructor and gear included.',
      'tasks.items.troodos-stargazing.title': 'Night stargazing in Troodos',
      'tasks.items.troodos-stargazing.description':
        'Book our astronomy session in Troodos and count constellations over Mount Olympos with an expert.',
      'tasks.items.limassol-bike-promenade.title': 'Bike the Molos promenade',
      'tasks.items.limassol-bike-promenade.description':
        'Rent a bike and ride at least 8 km along Limassol\'s seafront.',
      'tasks.items.larnaca-art-walk.title': 'Larnaca art walk',
      'tasks.items.larnaca-art-walk.description':
        'Visit three galleries or murals and describe your favourite piece in the travel journal.',
      'tasks.items.karpaz-donkey-care.title': 'Help at the donkey sanctuary',
      'tasks.items.karpaz-donkey-care.description':
        'Purchase our Karpas sanctuary volunteering and spend a morning feeding and grooming donkeys.',
      'tasks.items.halloumi-farm-visit.title': 'Halloumi farm visit',
      'tasks.items.halloumi-farm-visit.description':
        'Book a halloumi farm visit via WakacjeCypr.com and learn the process from herding to tasting.',
      'tasks.items.sunset-yoga-nissi.title': 'Sunset yoga at Nissi Beach',
      'tasks.items.sunset-yoga-nissi.description':
        'Sign up for a sunset yoga class and record a short audio story.',
      'tasks.items.premium-car-rental.title': 'Airport car rental pickup',
      'tasks.items.premium-car-rental.description':
        'Use our car rental with full insurance and collect your vehicle at Paphos or Larnaca airport.',
      'tasks.items.private-blue-lagoon-charter.title': 'Private Blue Lagoon charter',
      'tasks.items.private-blue-lagoon-charter.description':
        'Book an exclusive cruise or yacht from WakacjeCypr.com and explore Blue Lagoon with your own crew.',
      'tasks.items.troodos-private-tour.title': 'Private Troodos tour',
      'tasks.items.troodos-private-tour.description':
        'Arrange a full-day Troodos mountains trip with our guide and comfortable transport.',
      'tasks.items.nicosia-famagusta-combo.title': 'Nicosia & Famagusta combo tour',
      'tasks.items.nicosia-famagusta-combo.description':
        'Pick our combined package with a WakacjeCypr.com guide and see both sides of the island in one day.',
      'tasks.items.family-waterpark-day.title': 'Family day at the waterpark',
      'tasks.items.family-waterpark-day.description':
        'Buy a family package to one of our recommended water parks with hotel transfers.',
      'tasks.items.ayia-napa-sunset-cruise.title': 'Ayia Napa sunset cruise',
      'tasks.items.ayia-napa-sunset-cruise.description':
        'Book a romantic cruise with dinner and live music via WakacjeCypr.com.',
      'tasks.items.wedding-photoshoot-cyprus.title': 'Wedding photoshoot in Cyprus',
      'tasks.items.wedding-photoshoot-cyprus.description':
        'Use our wedding & photo service and arrange an outdoor shoot with our photographer and stylist.',
      ...
      'mediaTrips.card.variantHelper':
        'The calculator automatically updates the price and extra-person supplement.',
      ...
      'mediaTrips.items.vip-photo-trip.description':
        'Private photo sessions with a dedicated photographer and transport—perfect for families, couples, and friends.',
      ...
      'mediaTrips.items.vip-photo-trip.highlights.transport':
        'Premium transport with driver and locations planned for golden hour.',
      'mediaTrips.items.vip-photo-trip.highlights.stylist':
        'Stylist or make-up artist support available on request.',
      ...
      'mediaTrips.items.vip-video-trip.description':
        'Professional videographer, drone pilot, and video edit to capture your trip in premium quality.',
      ...
      'mediaTrips.items.vip-video-trip.highlights.crew':
        'Video crew with drone pilot, sound, and social media edits.',
      'mediaTrips.items.vip-video-trip.highlights.promo':
        'Possibility to produce promotional footage and behind-the-scenes coverage.',
      ...
      'auth.guest.switch': 'Logged out—you are now playing as a guest.',
      'auth.status.welcomeBack': 'Welcome back, {{username}}!',
      'auth.status.welcome': 'Welcome to the game, {{username}}!',
      'auth.status.loggedInAs': 'Signed in as {{username}}',
      ...
      'auth.error.invalidPassword': 'Incorrect password—try again.',
      ...
      'account.status.progressRestart': "You're starting the game over—good luck!",
      'account.status.resetNotAvailable': 'You\'re signed in—use account settings to reset your progress.',
