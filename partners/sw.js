const CACHE_VERSION = '20260922_114492';
...
function shouldHandleRequest(requestUrl) {
  try {
    ...
    if (url.pathname === '/partners/stripe-connect-return.html' || url.pathname === '/partners/stripe-connect-return' || url.pathname === '/partners/stripe-connect.html' || url.pathname === '/partners/stripe-connect') return false;
